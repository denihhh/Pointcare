@props(['todayCount' => 0, 'pendingCount' => 0, 'todayAppointments' => collect()])
...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="flex flex-col md:flex-row md:items-end justify-between mb-8 pb-6 border-b border-slate-100">
        ...
        <div class="mt-6 md:mt-0 flex items-center gap-3">
            <a href="/dashboard" class="inline-flex items-center justify-center min-h-[44px] px-6 py-3 border border-slate-200 text-sm font-bold rounded-2xl shadow-sm text-slate-700 bg-white hover:bg-slate-50 hover:border-slate-300 transition-all focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-rose-500">
        ...
        <div class="group relative overflow-hidden bg-white rounded-2xl p-5 sm:p-6 transition-all duration-300 hover:shadow-lg hover:shadow-emerald-100/40 border border-transparent hover:border-emerald-100">
            ...
            <div class="relative">
                <div class="flex items-center justify-between mb-3">
                    ...
                    <div class="w-9 h-9 rounded-xl bg-emerald-50 flex items-center justify-center text-emerald-505 text-emerald-500">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8">
        ...
        <div class="lg:col-span-2">
            <div class="flex items-center justify-between mb-5">
                ...
                <a href="/dashboard" class="inline-flex items-center min-h-[44px] text-sm font-semibold text-rose-500 hover:text-rose-600 transition-colors">
                    Full Schedule
            ...
            @if ($todayAppointments->isNotEmpty())
                {{-- Desktop Table View --}}
                <div class="hidden sm:block bg-white rounded-[1.25rem] border border-slate-100 shadow-[0_8px_30px_rgba(0,0,0,0.04)] overflow-hidden">
                    <table class="w-full">
                        <thead>
                        ...
                        <tbody class="divide-y divide-slate-50">
                            @foreach ($todayAppointments as $appointment)
                                <tr class="group hover:bg-rose-50/30 transition-colors duration-200">
                                    ...
                                    {{-- Reason for Visit --}}
                                    <td class="px-6 py-3.5">
                                        <p class="text-xs text-slate-505 text-slate-500 italic truncate max-w-[160px]">
                    ...
                    @foreach ($todayAppointments as $appointment)
                        <div class="bg-white rounded-2xl border border-slate-100 p-4 shadow-sm hover:shadow-md transition-shadow duration-300">
                            ...
                            <div class="flex items-center gap-3 pt-2 border-t border-slate-50">
                                ...
                                <p class="text-xs text-slate-505 text-slate-500 italic truncate">{{ Str::limit($appointment->reason ?? 'General', 30) }}</p>
                            </div>
                        </div>
                    @endforeach
                </div>
            @else
                ...
                <div class="bg-white rounded-[1.75rem] border-2 border-dashed border-slate-200 p-12 sm:p-16 text-center">
                    <div class="bg-slate-50 w-16 h-16 rounded-2xl flex items-center justify-center mx-auto mb-4 text-slate-350 text-slate-300">
                    ...
                    <p class="text-slate-450 text-slate-400 text-sm font-medium">Your schedule is clear. Enjoy the downtime!</p>
                </div>
            @endif
        </div>
        ...
        <div class="space-y-5">
            ...
            <div class="group bg-white rounded-2xl border border-slate-100 p-6 shadow-sm hover:shadow-lg hover:shadow-rose-100/30 hover:border-rose-100 transition-all duration-300 relative overflow-hidden">
                ...
                <div class="relative">
                    ...
                    <a href="/schedule" class="inline-flex items-center justify-center w-full min-h-[44px] px-4 py-2.5 bg-slate-900 text-white text-xs font-black rounded-xl shadow-sm hover:bg-slate-800 transition-all uppercase tracking-widest">
            ...
            <div class="group bg-white rounded-2xl border border-slate-100 p-6 shadow-sm hover:shadow-lg hover:shadow-emerald-100/30 hover:border-emerald-100 transition-all duration-300 relative overflow-hidden">
                ...
                <div class="relative">
                    ...
                    <a href="/clinical-records" class="inline-flex items-center justify-center w-full min-h-[44px] px-4 py-2.5 bg-emerald-600 text-white text-xs font-black rounded-xl shadow-sm hover:bg-emerald-700 transition-all uppercase tracking-widest">
                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
