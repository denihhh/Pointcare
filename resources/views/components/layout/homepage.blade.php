@props(['upcomingAppointment' => null])

<x-animation>
@if (auth()->user()->role === 'patient')
    <div class=" max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-10 space-y-4 md:space-y-0 pb-6 border-b border-gray-300">
            <div>
                <h1 class="text-3xl font-extrabold text-slate-900 tracking-tight">Hello, {{ auth()->user()->name }}</h1>
            ...
            <div class="space-y-8">
                <section class="bg-slate-900 rounded-3xl p-8 text-white shadow-xl relative overflow-hidden">
                    <div class="relative z-10">
                        ...
                        <p class="text-slate-400 text-sm leading-relaxed">Remember to stay hydrated! Aim for at least 8
                            glasses of water a day to maintain optimal kidney function.</p>
                        <button class="mt-6 text-sm font-bold text-rose-400 hover:text-rose-300 transition-colors">Read
                            More &rarr;</button>
                    </div>
                ...
                <div class="bg-white border border-slate-200 rounded-3xl p-6">
                    ...
                    <ul class="space-y-3">
                        <li><a href="#" class="text-slate-600 hover:text-rose-500 text-sm flex items-center"><span
    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="flex flex-col md:flex-row md:items-end justify-between mb-10 pb-6 border-b border-gray-300">
            <div>
                ...
                <p class="text-slate-500 mt-2 text-lg">You have <span class="text-slate-900 font-bold">12
                        consultations</span> scheduled for today.</p>
            </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
            <div class="bg-white border border-slate-200 rounded-2xl p-5 shadow-sm">
                ...
                <h3 class="text-2xl font-black text-slate-900">12 Today</h3>
            </div>
            <div class="bg-white border border-slate-200 rounded-2xl p-5 shadow-sm">
                <p class="text-slate-500 text-xs font-bold uppercase tracking-wider">Pending Approvals</p>
                <h3 class="text-2xl font-black text-rose-500">4 New</h3>
            </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div class="lg:col-span-2">
                ...
                @if ($upcomingAppointment)
                    <div
                        ...
                        <div
                            ...
                            <div class="flex-1 text-center sm:text-left">
                                ...
                                <div class="mt-4 p-4 bg-slate-50 rounded-2xl border border-slate-100">
                                    <p class="text-xs text-slate-400 font-bold uppercase mb-1">Reason for Consultation
                                    </p>
                        ...
                        <div class="bg-slate-50 border-t border-slate-100 px-8 py-4 flex justify-end space-x-4">
                            <button class="text-sm font-bold text-slate-500 hover:text-slate-700 transition">Patient
                                History</button>
                            <a href="/dashboard"
                ...
                @else
                    <div class="bg-slate-50 border-2 border-dashed border-slate-200 rounded-3xl p-16 text-center">
                        ...
                        <p class="text-slate-500 font-medium italic">You're all caught up! No more patients for today.
                        </p>
                    </div>
                @endif
            </div>
            ...
            <div class="space-y-6">
                ...
                <div class="bg-indigo-900 rounded-3xl p-6 text-white relative overflow-hidden">
                    ...
                    <p class="text-indigo-300 text-xs mb-4 relative z-10">Access the centralized medical database for
