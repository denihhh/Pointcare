            ...
            <div class="p-8 sm:p-12">
                @if($appointments->isEmpty())
                    <div class="py-16 text-center">
                        ...
                        <p class="text-slate-500 mt-2 max-w-xs mx-auto text-sm">Your clinical schedule is currently clear.
                            Ready to book your first consultation?</p>

                        <a href="/appointments/create"
                            class="inline-flex mt-8 bg-rose-500 text-white px-8 py-4 rounded-2xl font-black shadow-lg shadow-rose-200 hover:bg-rose-600 transition-all hover:-translate-y-1">
